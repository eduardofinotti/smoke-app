...
export default class WhatsAppTextInput extends Component {
    ...
    render() {
        return (
            <Animated.View style={{ marginBottom: this.state.keyboardOffset, position: 'absolute', width: '105%', bottom: 0 }}>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{ justifyContent: 'flex-end' }}>
                            <View style={[style.sendButtonStyle, { 
                                ...
                                <Image style={{ width: 30, height: 30 }} source={require('../assets/enviar.png')} />
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
